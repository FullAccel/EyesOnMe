...
class PlanDelete1 extends StatefulWidget {
  const PlanDelete1({super.key});

  @override
  State<PlanDelete1> createState() => _PlanDelete1State();
}

class _PlanDelete1State extends State<PlanDelete1> {
  final reasons = [
    "이전 일정을 아직 못 끝냈어요.",
    "집중이 잘 되지 않아요.",
    "다른 일정이 생겼어요",
  ...
  canGoNext() {
    if (wasPressed >= 0 || textController.text.isNotEmpty) {
      return Get.toNamed('/plan/delete2', arguments: Get.arguments);
    }
