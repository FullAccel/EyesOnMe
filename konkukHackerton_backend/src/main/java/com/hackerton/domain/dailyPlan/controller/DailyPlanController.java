package com.hackerton.domain.dailyPlan.controller;
...
import com.hackerton.domain.dailyPlan.service.DailyPlanService;
...
public class DailyPlanController {
    ...
    {
        DailyPlanMonthListDto monthDailyPlanList = dailyPlanService.getMonthDailyPlanListByMemberId(memberId, yearMonth);
        return ResponseEntity.ok(ResultResponse.of(GET_MONTH_DAILYPLAN_SUCCESS, monthDailyPlanList));
    }
}
